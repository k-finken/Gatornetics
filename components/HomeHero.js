...
function Index({foundPlayer}) {
    ...
    return (
        <section className="">
            <div className="flex flex-wrap justify-center max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div className="ml-4 mr-5 sm:mr-10 md:mr-16 lg:mr-20 place-self-center lg:col-span-7">
                ...
                <div className="mr-10 mt-10 sm:mt-0 lg:col-span-5 lg:flex max-w-[300px] max-h-[300px] sm:min-w-[400px] sm:min-h-[400px]"> 
